...
| Скрывать спонсорский баннер | вкл | убирает рекламный блок сверху и ряд карточек под ним |

Настройки по умолчанию дают ровно три состояния: принять, в процессе, забрать награду.

Баннер убирается не скрытием готовой разметки, а возвратом `null` из метода стора рекламы. Это значение там штатное, оно означает «для этого места рекламы не подобралось», поэтому Discord сворачивает блок сам и дыр в вёрстке не остаётся.
